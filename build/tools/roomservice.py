...
# Copyright (C) 2016-2017, The PixelBuilds Project
#
...
custom_local_manifest = ".repo/local_manifests/pixelbuilds.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'retina')
custom_dependencies = "pixelbuilds.dependencies"
