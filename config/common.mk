...
PRODUCT_COPY_FILES += \
    ...
    vendor/pixelbuilds/prebuilt/common/bin/50-lineage.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-lineage.sh
...
include vendor/pixelbuilds/config/aosp_audio.mk
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/pixelbuilds/overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pixelbuilds/overlay/common
